...
from .routers import auth, awx_callbacks, dashboard, execution_environments, execution_options, host_groups, hosts, inventory_sources, packages, patching, patching_panel, policies, users
...
for r in (auth.router, dashboard.router, hosts.router, host_groups.router, users.router, patching.router,
          ...
          inventory_sources.router, execution_environments.router):
