...
from .routers import auth, awx_callbacks, credentials, dashboard, execution_environments, execution_options, host_groups, hosts, inventory_sources, packages, patching, patching_panel, policies, templates, users
